...
/**
 * @file AboutMe.tsx
 * @description About Me section displayed on the home page.
 *
 * Key features:
 * - Split layout: profile photo left, bio paragraph right (stacked on mobile)
 * - Real profile image via next/image with fallback styling
 * - Three CTA buttons: Contact Me, LinkedIn, WhatsApp
 * - Framer Motion whileInView slide-in animations for both columns
 */
...
/** Inline LinkedIn SVG icon for use inside button labels. */
const LinkedInIcon = () => (
...
/** Inline WhatsApp SVG icon for use inside button labels. */
const WhatsAppIcon = () => (
  <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
 ...
 * Shows profile photo, bio, and three action buttons.
 */
  ...
  return (
    <section className="px-6 md:px-10 py-20 border-t border-border-card">
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        ...
        >
          {/* Profile photo — 320×320 max-width, rounded, object-cover */}
          <div className="w-full max-w-[320px] mx-auto rounded-xl border border-border-card bg-surface overflow-hidden aspect-square">
            <Image
              src="/profile.webp"
